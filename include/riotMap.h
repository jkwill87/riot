...
/*DESCRIPTION: Retrieves information from the given map and stores this data into a path structure.
...
/*DESCRIPTION: Copies the elements from the initalMap to the dupeMap
  ARGUMENTS: -Initial Map Pointer, Map pointer for the duplicate to be used during gameplay (struct Map *initialMap).
